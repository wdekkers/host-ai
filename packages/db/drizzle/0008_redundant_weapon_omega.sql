...
--> statement-breakpoint
CREATE INDEX "agent_configs_organization_id_idx" ON "walt"."agent_configs" USING btree ("organization_id");--> statement-breakpoint
CREATE INDEX "property_guidebook_entries_organization_id_idx" ON "walt"."property_guidebook_entries" USING btree ("organization_id");--> statement-breakpoint
