...
**Story ID:** `E09-S08`  
**Status:** Draft  
**Primary Actor:** safety and legal

## User Story
As safety and legal, I want an escalation matrix for always-manual scenarios (refunds, threats, injuries, accusations) so risk handling is controlled.

## Story Intent
This story exists to deliver a concrete capability in the AI STR OS command center: an escalation matrix for always-manual scenarios (refunds, threats, injuries, accusations). The expected business impact is that risk handling is controlled.
