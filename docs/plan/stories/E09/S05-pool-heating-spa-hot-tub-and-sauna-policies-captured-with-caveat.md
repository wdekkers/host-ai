...
**Story ID:** `E09-S05`  
**Status:** Draft  
**Primary Actor:** an amenity operator

## User Story

As an amenity operator, I want pool heating, spa/hot tub, and sauna policies captured with caveats and safety details so drafts avoid misinformation.

## Story Intent

This story exists to deliver a concrete capability in the AI STR OS command center: pool heating, spa/hot tub, and sauna policies captured with caveats and safety details. The expected business impact is that drafts avoid misinformation.
