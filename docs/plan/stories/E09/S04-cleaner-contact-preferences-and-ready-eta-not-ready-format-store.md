...
**Story ID:** `E09-S04`  
**Status:** Draft  
**Primary Actor:** ops workflow

## User Story
As ops workflow, I want cleaner contact preferences and READY/ETA/NOT READY format stored so JIT readiness checks are usable.

## Story Intent
This story exists to deliver a concrete capability in the AI STR OS command center: cleaner contact preferences and READY/ETA/NOT READY format stored. The expected business impact is that JIT readiness checks are usable.
