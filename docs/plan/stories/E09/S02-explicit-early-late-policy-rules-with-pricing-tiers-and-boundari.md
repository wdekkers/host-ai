...
## User Story
As a host, I want explicit early/late policy rules with pricing tiers and boundaries so AI can answer exceptions correctly.

## Story Intent
This story exists to deliver a concrete capability in the AI STR OS command center: explicit early/late policy rules with pricing tiers and boundaries. The expected business impact is that AI can answer exceptions correctly.
