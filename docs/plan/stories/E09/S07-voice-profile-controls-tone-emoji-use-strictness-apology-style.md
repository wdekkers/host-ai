...
**Story ID:** `E09-S07`  
**Status:** Draft  
**Primary Actor:** brand management

## User Story
As brand management, I want voice profile controls (tone, emoji use, strictness, apology style) so communication stays on-brand.

## Story Intent
This story exists to deliver a concrete capability in the AI STR OS command center: voice profile controls (tone, emoji use, strictness, apology style). The expected business impact is that communication stays on-brand.
