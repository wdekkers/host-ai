...
As operations, I want entry, lock, and parking instructions structured so arrival support is accurate.

## Story Intent

This story exists to deliver a concrete capability in the AI STR OS command center: entry, lock, and parking instructions structured. The expected business impact is that arrival support is accurate.
