...
**Story ID:** `E09-S06`  
**Status:** Draft  
**Primary Actor:** a property manager

## User Story
As a property manager, I want amenity importance indexing (critical/important/enhancer) so incident priority reflects business impact.

## Story Intent
This story exists to deliver a concrete capability in the AI STR OS command center: amenity importance indexing (critical/important/enhancer). The expected business impact is that incident priority reflects business impact.
