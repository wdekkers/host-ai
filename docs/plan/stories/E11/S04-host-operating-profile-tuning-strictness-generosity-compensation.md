...
**Epic:** [Epic 11: Guest Risk and Trust Intelligence](../../epics/E11-guest-risk-and-trust-intelligence.md)  
**Story ID:** `E11-S04`  
**Status:** Draft  
**Primary Actor:** host configuration

## User Story
As host configuration, I want Host Operating Profile tuning (strictness, generosity, compensation, economic sensitivity) so guidance aligns with owner strategy.

## Story Intent
This story exists to deliver a concrete capability in the AI STR OS command center: Host Operating Profile tuning (strictness, generosity, compensation, economic sensitivity). The expected business impact is that guidance aligns with owner strategy.
