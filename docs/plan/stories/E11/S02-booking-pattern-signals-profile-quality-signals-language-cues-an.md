...
**Story ID:** `E11-S02`  
**Status:** Draft  
**Primary Actor:** risk analysis

## User Story
As risk analysis, I want booking pattern signals, profile quality signals, language cues, and policy-violation flags so assessment is comprehensive.

## Story Intent
This story exists to deliver a concrete capability in the AI STR OS command center: booking pattern signals, profile quality signals, language cues, and policy-violation flags. The expected business impact is that assessment is comprehensive.
