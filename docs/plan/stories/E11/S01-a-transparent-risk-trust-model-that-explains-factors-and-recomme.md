...
## User Story
As a host, I want a transparent risk/trust model that explains factors and recommendations so I can act confidently.

## Story Intent
This story exists to deliver a concrete capability in the AI STR OS command center: a transparent risk/trust model that explains factors and recommendations. The expected business impact is that I can act confidently.
