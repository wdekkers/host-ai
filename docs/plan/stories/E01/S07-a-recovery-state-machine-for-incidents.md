...
**Story ID:** `E01-S07`  
**Status:** Draft  
**Primary Actor:** an operations lead

## User Story
As an operations lead, I want a recovery state machine for incidents so cases close cleanly after accepted resolution.

## Story Intent
This story exists to deliver a concrete capability in the AI STR OS command center: a recovery state machine for incidents. The expected business impact is that cases close cleanly after accepted resolution.
