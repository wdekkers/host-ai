...
## User Story
As a host, I want globally portable guest trust and locally configurable risk tolerance so recommendations fit each property.

## Story Intent
This story exists to deliver a concrete capability in the AI STR OS command center: globally portable guest trust and locally configurable risk tolerance. The expected business impact is that recommendations fit each property.
