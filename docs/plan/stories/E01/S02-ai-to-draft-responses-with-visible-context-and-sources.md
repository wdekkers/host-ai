...
## User Story
As a host, I want AI to draft responses with visible context and sources so I can trust and verify every recommendation.

## Story Intent
This story exists to deliver a concrete capability in the AI STR OS command center: AI to draft responses with visible context and sources. The expected business impact is that I can trust and verify every recommendation.
