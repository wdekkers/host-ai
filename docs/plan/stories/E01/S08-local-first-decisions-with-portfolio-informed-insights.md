...
**Epic:** [Epic 1: Product North Star and Operating Principles](../../epics/E01-product-north-star-and-operating-principles.md)  
**Story ID:** `E01-S08`  
**Status:** Draft  
**Primary Actor:** a portfolio manager

## User Story
As a portfolio manager, I want local-first decisions with portfolio-informed insights so immediate context and long-term learning both improve outcomes.

## Story Intent
This story exists to deliver a concrete capability in the AI STR OS command center: local-first decisions with portfolio-informed insights. The expected business impact is that immediate context and long-term learning both improve outcomes.
