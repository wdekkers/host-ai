...
As a host, I want approval/edit/send as the default flow so I stay in control of outbound guest communication.

## Story Intent

This story exists to deliver a concrete capability in the AI STR OS command center: approval/edit/send as the default flow. The expected business impact is that I stay in control of outbound guest communication.
