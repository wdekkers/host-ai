...
As an operator, I want a control-tower dashboard that shows what matters today so I can prioritize guest communication and operations quickly.

## Story Intent

This story exists to deliver a concrete capability in the AI STR OS command center: a control-tower dashboard that shows what matters today. The expected business impact is that I can prioritize guest communication and operations quickly.
