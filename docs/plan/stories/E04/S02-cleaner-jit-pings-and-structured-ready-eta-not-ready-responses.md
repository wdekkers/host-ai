...
**Story ID:** `E04-S02`  
**Status:** Draft  
**Primary Actor:** a host handling early check-in

## User Story
As a host handling early check-in, I want cleaner JIT pings and structured READY/ETA/NOT READY responses so guest expectations are accurate.

## Story Intent
This story exists to deliver a concrete capability in the AI STR OS command center: cleaner JIT pings and structured READY/ETA/NOT READY responses. The expected business impact is that guest expectations are accurate.
