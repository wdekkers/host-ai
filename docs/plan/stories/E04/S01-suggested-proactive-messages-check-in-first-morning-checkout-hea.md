...
**Epic:** [Epic 4: V1.5 Proactive Suggestions and Priority Surfacing](../../epics/E04-v1-5-proactive-suggestions-and-priority-surfacing.md)  
**Story ID:** `E04-S01`  
**Status:** Draft  
**Primary Actor:** an operator

## User Story
As an operator, I want suggested proactive messages (check-in, first-morning, checkout, heads-ups) so communication happens before issues escalate.

## Story Intent
This story exists to deliver a concrete capability in the AI STR OS command center: suggested proactive messages (check-in, first-morning, checkout, heads-ups). The expected business impact is that communication happens before issues escalate.
