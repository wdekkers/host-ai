...
As a user, I want a Today’s Priorities panel under the queue so operational risks are visible without leaving the main workflow.

## Story Intent

This story exists to deliver a concrete capability in the AI STR OS command center: a Today’s Priorities panel under the queue. The expected business impact is that operational risks are visible without leaving the main workflow.
