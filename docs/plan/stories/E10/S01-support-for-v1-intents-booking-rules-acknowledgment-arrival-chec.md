...
**Epic:** [Epic 10: Messaging Intent Taxonomy and Guardrails](../../epics/E10-messaging-intent-taxonomy-and-guardrails.md)  
**Story ID:** `E10-S01`  
**Status:** Draft  
**Primary Actor:** messaging automation

## User Story

As messaging automation, I want support for v1 intents (booking, rules acknowledgment, arrival/checkout, pool, early/late, spa, sauna) so common workflows are covered.

## Story Intent

This story exists to deliver a concrete capability in the AI STR OS command center: support for v1 intents (booking, rules acknowledgment, arrival/checkout, pool, early/late, spa, sauna). The expected business impact is that common workflows are covered.
