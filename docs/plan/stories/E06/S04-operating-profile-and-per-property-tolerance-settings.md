...
As a host, I want operating profile and per-property tolerance settings so AI recommendations match business style and constraints.

## Story Intent

This story exists to deliver a concrete capability in the AI STR OS command center: operating profile and per-property tolerance settings. The expected business impact is that AI recommendations match business style and constraints.
