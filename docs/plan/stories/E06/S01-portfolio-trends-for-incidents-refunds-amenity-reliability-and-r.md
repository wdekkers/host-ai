...
**Epic:** [Epic 6: V3 Portfolio Intelligence and Selective Autopilot](../../epics/E06-v3-portfolio-intelligence-and-selective-autopilot.md)  
**Story ID:** `E06-S01`  
**Status:** Draft  
...
As leadership, I want portfolio trends for incidents, refunds, amenity reliability, and response KPIs so we optimize the operating model across properties.

## Story Intent

This story exists to deliver a concrete capability in the AI STR OS command center: portfolio trends for incidents, refunds, amenity reliability, and response KPIs. The expected business impact is that we optimize the operating model across properties.
