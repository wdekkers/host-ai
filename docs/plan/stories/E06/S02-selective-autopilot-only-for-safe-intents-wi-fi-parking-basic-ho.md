...
## User Story
As a host, I want selective autopilot only for safe intents (Wi-Fi, parking, basic how-to) so automation scales while limiting risk.

## Story Intent
This story exists to deliver a concrete capability in the AI STR OS command center: selective autopilot only for safe intents (Wi-Fi, parking, basic how-to). The expected business impact is that automation scales while limiting risk.
