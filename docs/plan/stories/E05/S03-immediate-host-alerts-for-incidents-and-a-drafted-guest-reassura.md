...
## User Story
As a host, I want immediate host alerts for incidents and a drafted guest reassurance message so we respond quickly and appropriately.

## Story Intent
This story exists to deliver a concrete capability in the AI STR OS command center: immediate host alerts for incidents and a drafted guest reassurance message. The expected business impact is that we respond quickly and appropriately.
