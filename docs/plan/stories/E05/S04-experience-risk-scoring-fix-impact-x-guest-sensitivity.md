...
As an operator, I want experience risk scoring (Fix Impact x Guest Sensitivity) so communication urgency and compensation decisions are separated and rational.

## Story Intent

This story exists to deliver a concrete capability in the AI STR OS command center: experience risk scoring (Fix Impact x Guest Sensitivity). The expected business impact is that communication urgency and compensation decisions are separated and rational.
