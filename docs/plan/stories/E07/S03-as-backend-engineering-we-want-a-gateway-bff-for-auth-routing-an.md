...
## User Story
As backend engineering, we want a gateway/BFF for auth, routing, and rate limiting so service access is consistent and secure.

## Story Intent
This story exists to deliver a concrete capability in the AI STR OS command center: As backend engineering, we want a gateway/BFF for auth, routing, and rate limiting so service access is consistent and secure. The expected business impact is that the intended business outcome is achieved.
