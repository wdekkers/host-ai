...
As platform engineering, we want dedicated identity, messaging, ops, and notification services so concerns are separated and scalable.

## Story Intent

This story exists to deliver a concrete capability in the AI STR OS command center: As platform engineering, we want dedicated identity, messaging, ops, and notification services so concerns are separated and scalable. The expected business impact is that the intended business outcome is achieved.
