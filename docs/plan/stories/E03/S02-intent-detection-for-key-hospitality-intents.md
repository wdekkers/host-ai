...
As an operator, I want intent detection for key hospitality intents so message handling is categorized and prioritized.

## Story Intent

This story exists to deliver a concrete capability in the AI STR OS command center: intent detection for key hospitality intents. The expected business impact is that message handling is categorized and prioritized.
