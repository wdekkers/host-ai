# Story 3.1: Ingest guest messages from Hospitable webhooks

**Epic:** [Epic 3: V1 Reactive Communication Command Center](../../epics/E03-v1-reactive-communication-command-center.md)  
**Story ID:** `E03-S01`  
**Status:** Draft  
**Primary Actor:** a system

## User Story

As a system, I want to ingest guest messages from Hospitable webhooks so inbound communication enters the command center automatically.

## Story Intent

This story exists to deliver a concrete capability in the AI STR OS command center: to ingest guest messages from Hospitable webhooks. The expected business impact is that inbound communication enters the command center automatically.
