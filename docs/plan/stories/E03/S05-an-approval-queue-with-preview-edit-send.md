...
As a host, I want an approval queue with Preview/Edit/Send so communication can be handled fast with oversight.

## Story Intent

This story exists to deliver a concrete capability in the AI STR OS command center: an approval queue with Preview/Edit/Send. The expected business impact is that communication can be handled fast with oversight.
