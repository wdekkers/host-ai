...
**Story ID:** `E03-S03`  
**Status:** Draft  
**Primary Actor:** AI orchestration

## User Story
As AI orchestration, I want per-property context assembly from policies, docs (RAG), and reservation context so drafts are accurate and relevant.

## Story Intent
This story exists to deliver a concrete capability in the AI STR OS command center: per-property context assembly from policies, docs (RAG), and reservation context. The expected business impact is that drafts are accurate and relevant.
