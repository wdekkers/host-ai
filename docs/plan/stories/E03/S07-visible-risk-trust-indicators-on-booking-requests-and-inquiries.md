...
## User Story
As a host, I want visible risk/trust indicators on booking requests and inquiries so I can decide with better context.

## Story Intent
This story exists to deliver a concrete capability in the AI STR OS command center: visible risk/trust indicators on booking requests and inquiries. The expected business impact is that I can decide with better context.
