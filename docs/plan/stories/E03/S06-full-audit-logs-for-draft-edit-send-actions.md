...
As compliance, I want full audit logs for draft/edit/send actions so decisions are traceable by actor and timestamp.

## Story Intent

This story exists to deliver a concrete capability in the AI STR OS command center: full audit logs for draft/edit/send actions. The expected business impact is that decisions are traceable by actor and timestamp.
