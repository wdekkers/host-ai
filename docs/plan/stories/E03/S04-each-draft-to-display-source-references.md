...
## User Story
As a host, I want each draft to display source references so I can validate why the draft was generated.

## Story Intent
This story exists to deliver a concrete capability in the AI STR OS command center: each draft to display source references. The expected business impact is that I can validate why the draft was generated.
