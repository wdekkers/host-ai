...
As operations, I want readiness computed beyond cleaning (vendor conflicts, maintenance, critical amenities) so guest-impact risk is surfaced early.

## Story Intent

This story exists to deliver a concrete capability in the AI STR OS command center: readiness computed beyond cleaning (vendor conflicts, maintenance, critical amenities). The expected business impact is that guest-impact risk is surfaced early.
