...
**Story ID:** `E12-S05`  
**Status:** Draft  
**Primary Actor:** system orchestration

## User Story

As system orchestration, I want incident lifecycle states (Active -> Negotiation -> Resolution Accepted -> Recovery Closed -> Normalized) so closure is consistent.

## Story Intent

This story exists to deliver a concrete capability in the AI STR OS command center: incident lifecycle states (Active -> Negotiation -> Resolution Accepted -> Recovery Closed -> Normalized). The expected business impact is that closure is consistent.
