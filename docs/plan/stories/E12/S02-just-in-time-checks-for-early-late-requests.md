...
**Story ID:** `E12-S02`  
**Status:** Draft  
**Primary Actor:** v1.5 operations

## User Story

As v1.5 operations, I want just-in-time checks for early/late requests so intervention is targeted and lightweight.

## Story Intent

This story exists to deliver a concrete capability in the AI STR OS command center: just-in-time checks for early/late requests. The expected business impact is that intervention is targeted and lightweight.
