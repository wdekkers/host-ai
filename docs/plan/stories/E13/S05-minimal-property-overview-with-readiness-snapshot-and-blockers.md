...
As a manager, I want minimal property overview with readiness snapshot and blockers so portfolio scanning is fast.

## Story Intent

This story exists to deliver a concrete capability in the AI STR OS command center: minimal property overview with readiness snapshot and blockers. The expected business impact is that portfolio scanning is fast.
