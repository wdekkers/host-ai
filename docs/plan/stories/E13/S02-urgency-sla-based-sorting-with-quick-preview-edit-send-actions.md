...
## User Story
As an operator, I want urgency/SLA-based sorting with quick Preview/Edit/Send actions so response times improve.

## Story Intent
This story exists to deliver a concrete capability in the AI STR OS command center: urgency/SLA-based sorting with quick Preview/Edit/Send actions. The expected business impact is that response times improve.
