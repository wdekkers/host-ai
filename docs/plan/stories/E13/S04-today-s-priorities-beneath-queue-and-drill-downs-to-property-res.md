...
**Epic:** [Epic 13: Command Center UX and Workflow](../../epics/E13-command-center-ux-and-workflow.md)  
**Story ID:** `E13-S04`  
**Status:** Draft  
...
As an operator, I want Today’s Priorities beneath queue and drill-downs to property/reservation details so operational context is one click away.

## Story Intent

This story exists to deliver a concrete capability in the AI STR OS command center: Today’s Priorities beneath queue and drill-downs to property/reservation details. The expected business impact is that operational context is one click away.
