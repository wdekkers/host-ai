...
## User Story
As a host, I want Approval Queue as the default landing screen so communication decisions are the first action every day.

## Story Intent
This story exists to deliver a concrete capability in the AI STR OS command center: Approval Queue as the default landing screen. The expected business impact is that communication decisions are the first action every day.
