...
export const GET = withPermission(
  'dashboard.read',
  async (request, context, authContext) => handleGetPropertyAgentConfig(request, context as Params, authContext),
);

export const PUT = withPermission(
  'ops.write',
  async (request, context, authContext) => handlePutPropertyAgentConfig(request, context as Params, authContext),
);
