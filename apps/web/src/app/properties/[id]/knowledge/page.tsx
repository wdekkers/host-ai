...
export default async function PropertyKnowledgePage({
  params,
}: {
    ...
    <div className="p-4 sm:p-8 max-w-5xl">
      ...
      <div className="mb-6 mt-3">
        ...
        <p className="mt-1 text-sm text-gray-500">
          Manage property-specific FAQ and guidebook content. Property entries override matching
          global knowledge by topic key.
        </p>
      </div>
